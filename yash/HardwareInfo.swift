...
@objc public class HardwareInfo:NSObject {
    ...
    @objc public static func getInternalDeviceId(jsonString:String) -> String? {
        var internalDeviceId = ""
        ...
        if applicationUUID==nil||applicationUUID=="" {
            ...
            internalDeviceId = applicationUUID as! String
        }
    ...
    do {
        ...
        if var dict = jsonObject as? [String: Any] {
            dict["internalDeviceId"] = internalDeviceId
            jsonObject = dict
        }
    ...
    @objc public func getStaticDeviceMetrics() -> String {
        ...
        let staticMetrics: [String: Any] = [
            ...
            "totalRamInMB": String(format: "%.2f", totalRamInMB),
            "numCores": String(numCores),
            "clockSpeedInHz": clockSpeed
        ]
        
        do {
            let jsonData = try JSONSerialization.data(withJSONObject: staticMetrics, options: .prettyPrinted)
